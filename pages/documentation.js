...
export default function Instructions() {
    const requirements = [
        ...
        {name:'Team', allowed:
        <Row>
            <Col><li className='w-75'>This column name is forbidden from being used in your .csv file. This column name will be added to the result of the algorithm and duplicate column names aren't allowed.</li></Col>
        </Row>},
        {name:'#', allowed:
        <Row>
            <Col><li className='w-75'>Any column or row containing the "#" character is forbidden from being used in your .csv file. When downloading the result .csv file, "#" characters are treated as comments so everything after the "#" will be ommitted from the outputted .csv file.</li></Col>
        </Row>},
    ]
